...
import Loader from "../Loader/Loader"; // adjust path to your existing Loader component
  ...
  return (
    <>
      ...
      <motion.nav
        ...
        className={`fixed top-0 w-full py-3 px-6 sm:px-16 z-40 transition-all ${
                      ...
                      <div key={nav.title}>
                        <motion.li
                          className={`flex items-center justify-between text-base ${
                            active === nav.title ? "text-[#915EFF]" : "text-gray-300 hover:text-white"
                          }`}
                          whileHover={{ x: 5 }}
                          onClick={(e) => {
                            if (nav.title === "Home") {
