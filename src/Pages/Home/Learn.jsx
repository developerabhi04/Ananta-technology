        ...
        <div className="min-h-screen bg-gray-50">
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="bg-white p-6 rounded-lg shadow hover:shadow-2xl transition duration-300">
                            ...
                            <a href="/blog/digital-transformation" className="text-indigo-600 font-semibold mt-4 inline-block">
                                Read More
                            </a>
                        </div>
                        {/* Resource Card 2 */}
                        ...
                        <div className="bg-white p-6 rounded-lg shadow hover:shadow-2xl transition duration-300">
                            ...
                            <a href="/blog/innovative-web" className="text-indigo-600 font-semibold mt-4 inline-block">
                                Read More
                            </a>
                        </div>
                    </div>
            ...
            <section className="bg-gradient-to-r from-purple-600 to-pink-500 text-white py-16">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <a href="/contact-page" className="bg-white text-purple-600 py-3 px-8 rounded-full font-semibold hover:bg-gray-100 transition">
                        Contact Us
                    </a>
                </div>
            </section>
