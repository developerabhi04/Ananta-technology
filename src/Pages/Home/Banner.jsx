...
// import vid from "../../assets/126662-736705634.mp4";
            ...
            <div className="relative z-0 bg-gradient-to-r from-[#1a041f] to-[#05000a] h-screen flex justify-center items-center overflow-hidden">
                ...
                >
                    ...
                    <div className="flex justify-center space-x-4">
                        <button className="px-8 py-3 bg-gradient-to-r from-[#915EFF] to-purple-600 text-white rounded-lg shadow-lg hover:opacity-90 transition-all duration-300" onClick={() => navigate("/contact-page")}>
                            Get Started
                        </button>
                        <button className="px-8 py-3 border border-white text-white rounded-lg hover:bg-white hover:text-slate-950 transition-all duration-300" onClick={() => navigate("/learn-more")}>
                            Learn More
                        </button>
                    </div>
